...
import { startOfHour, parseISO, isBefore, endOfHour, format, subHours } from 'date-fns';
...
class AppointmentController {
  ...
  async delete(req, res) {
    ...
    const formattedDate = format(appointment.date, "'dia' dd 'de' MMMM', às' H:mm'h'", {
      locale: pt,
    });
